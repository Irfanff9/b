...
case 'lock':
 lol = {
  "key": {
    "fromMe": false,
    participant: `6289510497533@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
  },
  "message": {
    "viewOnceMessage": {
      "message": {
...
• ${prefix}sandw *teks*`
              ...
              herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${menu}`, footerText: '• Subscribe IRFANFF9', buttons: [{ buttonId: `#sewa`, buttonText: { displayText: '乡SEWA BOT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: Herman2, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
Ayo Donasi;(`
       ...
       case 'src':
             ...
             HC = await getBuffer(`https://i.ibb.co/k0d97Rt/20220115-045910.jpg`)
              tex = `Hay Ka ${pushname}
• Sc Ori : https://github.com/Irfanff9/irfan
Creator : IRFANFF9

• Sc Recode : 
Creator :

Reuplod Kasih Wm [IRFANFF9]
Please Hargaiツ`
herman.updatePresence(from, Presence.composing)
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport': 
              ...
              herman.sendMessage('6289510497533@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'jawaban':
       ...
       case 'request':
              ...
              herman.sendMessage('6289510497533@s.whatsapp.net',`*Request:* ${teks}`, text)
              break
case 'chatrava':
              if (args.length < 1) return reply(`Ketik ${prefix}CHAT [CHAT apa]`) 
              teks = args.join(' ')
              reply('CHAT RAVA DONE')
              herman.sendMessage('6289510497533@s.whatsapp.net',`*chat:* ${teks}`, text)
              break
       case 'readall':
